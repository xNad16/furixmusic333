...
const yt_api_key = process.env.AIzaSyDEwYPuBjXDqespqBbJU7j8uEZKTI-WoWw;
const prefix = process.env.PREFIX;
const discord_token = process.env.NTk3MDE0MDI5ODg1NjM2NjM5.XSDGaw.hWo8XfFRwFwOLNOPBgC9Wc014uQ;
